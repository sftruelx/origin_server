...
import com.eserver.dao.UserDao;
import com.eserver.model.User;
import com.eserver.service.MailEngine;
import com.eserver.service.UserExistsException;
 ...
 */
@Service("userManager")
@WebService(serviceName = "UserService", endpointInterface = "com.eserver.service.UserService")
public class UserManagerImpl extends GenericManagerImpl<User, Long> implements UserManager, UserService {
     ...
     * @see com.eserver.service.MailEngine#sendMessage(org.springframework.mail.SimpleMailMessage, String, java.util.Map)
     */
