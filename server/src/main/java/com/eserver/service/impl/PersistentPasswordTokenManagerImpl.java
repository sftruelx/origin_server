...
public class PersistentPasswordTokenManagerImpl implements PasswordTokenManager {
    ...
    /**
     * @see com.eserver.service.impl.PasswordTokenManager#generateRecoveryToken(com.eserver.model.User)
     */
    @Override
    ...
    /**
     * @see com.eserver.service.impl.PasswordTokenManager#isRecoveryTokenValid(com.eserver.model.User, java.lang.String)
     */
    @Override
    ...
    /**
     * 
     * @see com.eserver.service.impl.PasswordTokenManager#invalidateRecoveryToken(User, String)
     */
    @Override
